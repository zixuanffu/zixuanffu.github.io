...
**Question**: I want to know how employment in market $m$ affects the number of programs in market $m$. (The red arrow refers to one market.)
...
For the first point, refer to the [slides](https://kohei-kawaguchi.github.io/AppliedEconometricsPublic/14_shift_share_design.html#6) or [Paul Goldsmith et al, 2019](http://paulgp.com/papers/bartik_gpss.pdf).